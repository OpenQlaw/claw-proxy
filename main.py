"""
claw-proxy — Quota-aware OpenAI-compatible gateway.
...
Dispatches to: copilot | claude_cli | local (LM Studio)
based on quota state and content security rules.
"""
import json
import time
import uuid
...
class ChatRequest(BaseModel):
    ...
    # Non-standard: caller can express a backend preference
    # claw_preferred_backend: "copilot" | "claude_cli" | "local" | None
